...
protected:
    ...
    GLuint bufJointID; // A Vertex Buffer Object that we will use to store IDs of the joints
    GLuint bufJointWeight; // A Vertex Buffer Object that we will use to store the weights of the joints
