...
public:
    ...
    // POLAR
    void RecomputeAttributesPolar();

    void RotateAboutUpPolar(float deg);
    void RotateAboutRightPolar(float deg);

    void TranslateAlongLookPolar(float amt);
    void TranslateAlongRightPolar(float amt);
    void TranslateAlongUpPolar(float amt);
};
